...
// process_folder
std::vector<json> process_folder(const std::string& folder_path, const std::string& output_json = "Algo2_Parallel_Cpp.json") {
...
int main() {
    ...
    auto t0 = std::chrono::high_resolution_clock::now();
    auto all_results = process_folder(folder, "Algo2_Parallel_Cpp.json");
    auto t1 = std::chrono::high_resolution_clock::now();
